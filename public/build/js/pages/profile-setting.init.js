...
// AdminBG Img
if (document.querySelector("#profile-img-file-input-2")) {
    document.querySelector("#profile-img-file-input-2").addEventListener("change", function () {
        var preview = document.querySelector(".user-profile-image-2");
        var file = document.querySelector(".profile-img-file-input-2").files[0];
        var reader = new FileReader();
        reader.addEventListener(
            "load",
            function () {
...
// Profile Foreground Img
if (document.querySelector("#profile-img-file-input-3")) {
    document.querySelector("#profile-img-file-input-3").addEventListener("change", function () {
        var preview = document.querySelector(".user-profile-image-3");
        var file = document.querySelector(".profile-img-file-input-3").files[0];
        var reader = new FileReader();
        reader.addEventListener(
            "load",
            function () {
